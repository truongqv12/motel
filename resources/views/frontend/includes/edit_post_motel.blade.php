...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="">Sửa tin</a></li>
    </ol>
@endsection
...
@section('content')
    <div class="post_motel_content mt-4">
        <div class="container clearfix">
            <form action="{{route('motel_post.post.update',['id'=> $motel->get('id')])}}" method="POST"
                  enctype="multipart/form-data" id="formMotel"
                    ...
                    <div class="col-md-2 norightpadding">
                        <div id="step-1" class="submit-list-type">
                            <div class="title-block">
                                <h4 class="step_title">{{ ($motel->get('use_need') == 0) ? 'Cho thuê': 'Ở ghép' }}</h4>
                            </div>
                        </div>
                        <div id="step-2" class="submit-list-type show">
                            <div class="title-block">
                                <h4 class="step_title">{{ $motel->get('category')->get('name') }}</h4>
                            </div>
                        </div>
                    </div>
                    <div id="step-3" class="col-md-10 no-padding-right submit-room-main-content show" style="">
                        <div class="title-block">
                            <h4 class="step_title">Sửa thông tin chi tiết</h4>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="control-label">Tiêu đề</div>
                                    <input type="text" name="title" class="form-control form_title"
                                           value="{{ $motel->get('title') }}"
                                           title="Tiêu đề" placeholder="Nhập tiêu đề">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control form_phone"
                                           value="{{ $motel->get('phone') }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form_price" name="price"
                                                       placeholder="Giá thuê" id=""
                                                       value="{{ $motel->get('price_number') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="area" value="{{ $motel->get('area') }}"
                                                       class="form-control form_area"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" name="address" class="form-control address_input"
                                                       value="{{ $motel->get('address') }}" id="maps_address"
                                            ...
                                            <div class="vs">
                                                ...
                                                <div>
                                                    <select name="toilet" class="form-control select2">
                                                        <option value="Khép kín" {{ ($motel->get('toilet') == 'Khép kin') ? 'selected' : ' '}}>
                                                            Khép kín
                                                        </option>
                                                        <option value="Chung" {{ ($motel->get('toilet') == 'Chung') ? 'selected' : ' '}}>
                                                            Chung
                                                        </option>
                                                        <option value="Chưa xác định" {{ ($motel->get('toilet') == 'Chưa xác định') ? 'selected' : ' '}}>
                                                            Chưa xác định
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group people-in">
                                            ...
                                            <div>
                                                <select name="people" class="form-control select2">
                                                    ...
                                                    <option value="1" {{ ($motel->get('people') == 1) ? 'selected' : ' '}}>
                                                        1 người
                                                    </option>
                                                    <option value="2" {{ ($motel->get('people') == 2) ? 'selected' : ' '}}>
                                                        2 người
                                                    </option>
                                                    <option value="3" {{ ($motel->get('people') == 3) ? 'selected' : ' '}}>
                                                        3 người
                                                    </option>
                                                    <option value="4" {{ ($motel->get('people') == 4) ? 'selected' : ' '}}>
                                                        4 người
                                                    </option>
                                                    <option value="5" {{ ($motel->get('people') == 5) ? 'selected' : ' '}}>
                                                        5 người
                                                    </option>
                                                    <option value="6" {{ ($motel->get('people') == 6) ? 'selected' : ' '}}>
                                                        6 người
                                                    </option>
                                                    <option value="7" {{ ($motel->get('people') == 7) ? 'selected' : ' '}}>
                                                        7 người
                                                    </option>
                                                    <option value="8" {{ ($motel->get('people') == 8) ? 'selected' : ' '}}>
                                                        8 người
                                                    </option>
                                                    <option value="9" {{ ($motel->get('people') == 9) ? 'selected' : ' '}}>
                                                        9 người
                                                    </option>
                                                </select>
                                            </div>
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input amenities_check"
                                                               name="amenities[]"
                                                               {{ (in_array($item->get('id'),$my_amenities)) ? 'checked' : ''}}
                                ...
                                <div class="submit-room-des">
                                    ...
                                    <div id="text_editer">
                                        <textarea name="description"
                                                  id="edit_layout">{{ $motel->get('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="maps[maps_maplat]"
                                                               id="maps_maplat" value="{{ $motel->get('lat') }}"
                                                               readonly="readonly">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="maps[maps_maplng]"
                                                               id="maps_maplng" value="{{ $motel->get('lng') }}"
                                                               readonly="readonly">
                                                    </div>
                                                </div>
                                            </div>
