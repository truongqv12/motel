...
<div id="side-panel">
    ...
    <div class="side-panel-wrap">
        ...
        <div class="widget clearfix">
            ...
            <form id="login-form-header" class="nobottommargin" action=""
                  method="POST" onsubmit="return validateLoginForm('login-form-header')">
                <div class="help-block show_err">

                </div>
                <div class="col_full">
                    <label class="t400">Tên đăng nhập:</label>
                    <input type="text" name="username" value=""
                           class="form-control login-form-username"/>
                </div>
                ...
                <ul>
                    ...
                    <li>
                        <a href="" class="select_user_toggle"><span class="icon-user4"></span>
                            <span class="t200 text-lowercase"><?= app('auth')->login_name ?></span></a>
