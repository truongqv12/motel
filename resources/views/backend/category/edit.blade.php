                    ...
                    <div class="box box-danger">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="cat_parent_id" title="">
                                    ...
                                    @if ($categories)
                                        @foreach($categories as $item)
                                            <option value="{{$item['id']}}" {{($cat['id'] == $item['id']) ? 'checked' : ''}}>
                                                {{$item['name']}}
                                            </option>
                                        @endforeach;
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" readonly class="form-control" placeholder="Rewrite" id="slug"
                                           name="cat_rewrite" value="{{ $cat['rewrite'] }}">
                                </div>
                            </div>
                        </div>
                        <div class="box-footer">
                            <div class="center-block max-width-content">
                                ...
                                <button type="submit" class="btn btn-lg btn-warning">Sửa <i
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="cat_active" value="0" {{($cat['active'] == 0) ? 'checked' : ''}}>
                                        <span class="label label-danger">Ban</span>
                                    </label>
                                    <label>
                                        <input checked type="radio" name="cat_active" value="1" {{($cat['active'] == 1) ? 'checked' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" title="SEO title" id="cat_seo_title"
                                       name="cat_seo_title" value="{{ $cat['seo']['title'] }}" maxlength="255">
                            </div>
                            <div class="form-group">
                                <label for="">SEO keywords :</label>
                                <input class="form-control" type="text" title="Mô tả" id="cat_seo_keyword"
                                       name="cat_seo_keyword" value="{{ $cat['seo']['keywords'] }}" maxlength="255">
                            </div>
                            <div class="form-group">
                                <label for="">SEO description :</label>
                                <textarea class="form-control" placeholder="Mô tả" id="cat_seo_description"
                                          name="cat_seo_description"
                                          style="resize: none; height:100px">{{ $cat['seo']['description'] }}</textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->
